...
const Header = () => {
  ...
  // Agregar un event listener para detectar clics fuera del menú desplegable
  useEffect(() => {
  ...
  return (
    <div className='flex w-full h-[80px] fixed border-b-[1px] bg-white transition-all duration-300' onClick={handleClickOutsideMenu}>
