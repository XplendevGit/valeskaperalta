...
const SobreMi = () => {
  return (
    <div className="overflow-hidden flex h-full w-full justify-center lg:px-24 lg:p-y-24 px-6 py-24 bg-gradient-to-r from-[#B7A1BC] to-[#d46d7c]">
        <div className={`flex container h-full w-full lg:px-24 ${style['contenedor-sobremi']}`}>

          <div className={`flex w-full h-full ${style['sobremi-1']}`}>
          ...
          <div className={`flex w-full h-full bg-red-200 ${style['sobremi-3']}`}>
